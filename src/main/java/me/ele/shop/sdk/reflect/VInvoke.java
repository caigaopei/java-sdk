...
public final class VInvoke {
    ...
    public static <T> T newInstance(Class<T> clazz) {
        ...
        Invokable<T, T> constructor = VInvoke.getConstructor(clazz);
        if (constructor == null) {
    ...
    public static Invokable getMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
        try {
    ...
    public static Set<Invokable> getAssignableMethods(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
        Set<Invokable> invokableSet = Sets.newHashSet();
        for (Method method : clazz.getMethods()) {
