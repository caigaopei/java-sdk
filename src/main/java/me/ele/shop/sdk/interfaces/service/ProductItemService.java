...
import me.ele.shop.sdk.interfaces.enumeration.item.OItemProperty;
...
public interface ProductItemService {
     ...
     * @return OItem
     */
    OItem createItem(@NotNull(message = "商品分类Id不能为空") long categoryId, @NotNull(message = "商品属性不能为空") Map<OItemProperty, Object> properties) throws ServiceException;
     ...
     * @return Map<Long,OItem>
     */
    Map<Long, OItem> batchCreateItems(@NotNull(message = "商品分类Id不能为空") long categoryId, @NotNull(message = "商品属性的列表不能为空") List<Map<OItemProperty, Object>> items) throws ServiceException;
     ...
     * @return OItem
     */
    OItem updateItem(@NotNull(message = "商品Id不能为空") long itemId, @NotNull(message = "商品属性不能为空") Map<OItemProperty, Object> properties) throws ServiceException;
